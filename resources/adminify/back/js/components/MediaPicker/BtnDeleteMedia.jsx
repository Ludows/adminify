...
//    const { hide } = useMediaPreview();
   ...
   const getUrlFormDelete = (media) => {
     return Route('medias.destroy', { media : media.id ? media.id : media });
   }
    ...
    return <Button ref={ref} disabled={handleDisabledState()} onClick={handleCLick} variant="danger">{ useMassDelete ? 'handle mass delete' : 'delete' }</Button>
})
