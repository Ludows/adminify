...
window.queryBuilderInitFunction = require('./extensions/queryBuilder').default;
...
jQuery(document).ready(function($) {
    ...
    if(window.admin.queryBuilder.length > 0) {
        queryBuilderInitFunction(window.admin.queryBuilder);
    }
})
