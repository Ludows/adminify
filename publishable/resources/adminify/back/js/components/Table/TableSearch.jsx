...
export default function TableSearch(props) {
    ...
    if(has('admin.'+ appData('name')+ '.create' ) ) {
        createRoute = route('admin.'+ appData('name') + '.create');
    }
    ...
    return <>
        <div class="col d-flex justify-content-end align-items-center text-right">
            ...
            <div class="ml-lg-3 mt-3 mt-lg-0 ms-lg-3">
                {createRoute && 
                    <button onClick={() => { HandleGo({url: createRoute}) }} class="btn btn-primary"> {get('admin.table.modules.btn_create')}</button>
                }
            </div>
        </div>
    </>
